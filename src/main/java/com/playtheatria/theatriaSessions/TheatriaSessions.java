...
public final class TheatriaSessions extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        CustomLogger<TheatriaSessions, ConfigManager> customLogger = new CustomLogger<>(
                configManager,
                "#f5428a",
                "#42f598",
                "#fff8bd"
        ...
        Objects.requireNonNull(getCommand("session")).setExecutor(new SessionCommand(sessionManager, priceManager, configManager));
    }
